  ...
  return (
    <article className="bg-white text-wiki-heading font-wiki-sans" itemScope itemType="https://schema.org/Person">
      ...
      <header className="border-b border-wiki-border pb-2 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Given my extensive and multifaceted career, I commissioned an AI to compile and organize my professional history into this Wikipedia-style format, creating a comprehensive and accessible overview of my work.</p>
      </header>
